<footer class="content">
    ...
    <div class="mb-[60px] mt-[40px]">
        <a wire:navigate href="{{ route('page.contacts') }}" class="text-[16px] px-[24px] py-[12px] rounded-[10px] bg-[#08338F] hover:bg-[#D02320] active:bg-[#D02320] text-white transition-all duration-300">Свяжитесь с нами</a>
    </div>
    <hr class="border-1 border-[#f2f2f2]">
