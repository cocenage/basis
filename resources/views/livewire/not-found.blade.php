...
<div class="h-screen content">
    ...
    <div class="pt-[60px]">
        <a wire:navigate href="{{ route('page.home') }}" class="text-[16px] px-[24px] py-[12px] rounded-[10px] bg-[#08338F] hover:bg-[#D02320] active:bg-[#D02320] text-white duration-300  ">Домой</a>
    </div>
</div>
